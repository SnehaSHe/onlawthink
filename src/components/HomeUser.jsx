          ...
          <div className="relative">
            ...
            {message === "Lawyers found" ? (
              <div className="absolute top-0 right-0 mt-8 mr-8 flex items-center">
                <input
                  type="text"
                  className="px-3 py-2 border border-purple-800 rounded-lg focus:outline-none bg-purple-100 text-purple-800 mr-2"
                  placeholder="Search..."
                />
                <select className="mr-2 px-4 py-2 bg-purple-500 text-white rounded-lg">
                  <option value="location">Search By Location</option>
                  <option value="case">Search By Case</option>
                </select>
